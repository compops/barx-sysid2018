...
from helpers import buildPhiMatrix, initialiseFIRlocationScaleMixture
...
sm = pystan.StanModel(file='example3_fir_locationscalemixture.stan')
fit = sm.sampling(data=data, iter=data['noIterations'], chains=data['noChains'], init=initialiseFIRlocationScaleMixture)

model=fit
name='fir_locationscalemixture'
