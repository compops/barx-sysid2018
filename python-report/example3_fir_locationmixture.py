...
from helpers import buildPhiMatrix, initialiseFIRlocationMixture
...
sm = pystan.StanModel(file='example3_fir_locationmixture.stan')
fit = sm.sampling(data=data, iter=data['noIterations'], chains=data['noChains'], init=initialiseFIRlocationMixture)

model=fit
name='fir_locationmixture'
